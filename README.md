# telegram-dm-nuker
Python script to wipe Telegram DMs using Telethon, irreversible, backup first.
Setup and Usage
...
Step-by-Step Run
1.  Clone or Download: git clone https://github.com/yourusername/telegram-dm-nuker.git && cd telegram-dm-nuker (swap yourusername). Or grab the ZIP, unzip.
2.  Fill Placeholders: Open dm_nuker.py in any editor (nano, VS Code, Notepad). Replace:
	...
	•  'YOUR_PHONE_HERE' with your phone like '+13364967384' (quotes, +country code).
	...
	•  'YOUR_OS_HERE' with something like 'Linux' or 'Win10' (quotes)—just for camo, doesn’t matter. Save it. Don’t commit this back—your keys stay local.
